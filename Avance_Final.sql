...
---- Crear un �ndice �nico en la combinaci�n de CheckNumber y CheckOwner
...
( 'Todo Incluido', 'Paquete completo con alimentaci�n y hospedaje.', 450.00, 0.45, 24),
('Alimentaci�n', 'Paquete que cubre todas las comidas durante la estancia.', 275.00, 0.35, 18),
('Hospedaje', 'Paquete de hospedaje sin alimentaci�n.', 210.00, 0.15, 12);
