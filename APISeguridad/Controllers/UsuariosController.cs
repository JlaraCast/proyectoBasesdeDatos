...
namespace APISeguridad.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public UsuariosController(DbContextSeguridad context, IAutorizacionServices autorizacionServices)
        {
            _context = context;
        ...
        [HttpPost]
        [Route("Autenticar")]
        public async Task<IActionResult> Autenticar(Usuario autenticar)
        {
        ...
        public IActionResult SearchByCorreo(string correo)
        {
            ...
            var temp = _context.usuarios.FirstOrDefault(x => x.correo.ToLower() == correo.ToLower());
